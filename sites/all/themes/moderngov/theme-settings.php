...
function agency_1_form_system_theme_settings_alter(&$form, &$form_state) {
  ...
  $form['background_image']['settings']['background_file'] = array(
    ...
    '#element_validate' => array('_agency_1_theme_settings_validate'),
  );
  ...
  $form['footer_contact_us']['settings']['footer_contact_us_map_image'] = array(
    ...
    '#element_validate' => array('_agency_1_theme_settings_map'),
  );
  //End Contact Us
...
function _agency_1_theme_settings_validate($form, &$form_state) {
...
function _agency_1_theme_settings_submit(&$form, &$form_state) {
//
//
//
//
...
function _agency_1_background_setting($form, &$form_state) {
//
//
//
//
 ...
 */
function agency_1_theme_settings_add_new_colors() {
