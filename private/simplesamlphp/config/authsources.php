...
// Entity ID
// The entity ID should be a string with no spaces and only use underscores (ie az_doa_okta)
// Note: Don't forget the '' around the string

$the_entityID = null;

// IDP Links for various environments
// IDP link should be pulled from the converted metadata provided by SI and the Okta Application
// It is found under the array from the converted metadta labeled as entityid => 'http://www.okta.com/xxxxxxxxxx'
// Note: Don't forget the '' around the string
