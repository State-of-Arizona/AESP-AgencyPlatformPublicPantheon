...
// Entity ID
//Will this be the same for all environments?
//$the_entityID = $az_okta_array['entity_id'];
//$the_entityID = 'az_aset_okta';

// IDP Links for various environments
//$live_idp = 'http://www.okta.com/exk1g2lol2QRVHjOH297';
$live_idp = $live_az_okta_xml['EntityDescriptor']['@entityID'];
// //$test_idp = 'http://www.okta.com/exk1g3z5t3rA6BsJk297';
$test_idp = $test_az_okta_xml['EntityDescriptor']['@entityID'];
//$dev_idp = 'http://www.okta.com/exk1g3zjvnI1RxZY4297';
$dev_idp = $az_okta_xml['EntityDescriptor']['@entityID'];

// Setting the default IDP
$the_idp = null;


// Depending on the environments, we can call specific IDP links
if (isset($_SERVER['PANTHEON_ENVIRONMENT']) && $_SERVER['PANTHEON_ENVIRONMENT'] === 'live' ) {
    $the_idp = $live_idp;
    $the_entityID = $live_az_okta_array['entity_id'];
}

if (isset($_SERVER['PANTHEON_ENVIRONMENT']) && $_SERVER['PANTHEON_ENVIRONMENT'] === 'test' ) {
    $the_idp = $test_idp;
    $the_entityID = $test_az_okta_array['entity_id'];
}
